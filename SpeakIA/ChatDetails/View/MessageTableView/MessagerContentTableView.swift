...
class MessagerContentTableView: UIView {
    ...
    /*[UserChat(id: "1", name: "Este es un mensjae de prueba"),
...
extension MessagerContentTableView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        dataSource?[indexPath.row].date = "Traduciendo al ingles con un texto mas amplio que se pueda traducir blablablbalba..."
        dataSource?[indexPath.row].isSeen = true
